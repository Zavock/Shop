  ...
  return (
    <div className='bg-white cursor-pointer w-56 h-60 rounded-lg border shadow-xl p-3'>
      <figure className='relative mb-2 w-full h-4/5'>
        ...
        <button className='absolute top-0 right-0 flex justify-center items-center bg-white/90 shadow-lg font-semibold w-6 h-6 rounded-full m-2 p-1' onClick={() => setCount(count + 1)}>
