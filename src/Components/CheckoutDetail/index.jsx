...
const CheckoutDetail = () => {
  ...
  return (
    <div className={`${isCheckoutDetailOpen ? 'flex' : 'hidden'} flex-col top-0 lg:top-[68px] md:top-[80px] shadow-2xl overflow-auto fixed right-0 border lg:border-black md:border-black bg-white rounded-lg w-full lg:w-[380px] md:w-[380px] min-h-screen h-[calc(100vh-60px)] lg:min-h-0 md:min-h-0 z-10`}>
